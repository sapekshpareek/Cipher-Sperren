...
def decode(message_string, start_int, end_int, shift):
    ...
    strings = charcter.shift_characters(message_string, -shift)
...
if __name__ == "__main__":
    ...
    end_int = int(key[1])
    shift = int(key[2])
    decrypted_message = decode(string, start_int, end_int, shift)
